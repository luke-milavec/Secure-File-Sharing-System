...
public class ClientTerminalApp {
    ...
    public void showOptions() {
        ...
        System.out.println("Options: " + newLine
                            ...
                            + "         gettoken <server_name>                              Fetch a token for the user that is logged in, where <server_name> is the name of the server where the token is intended to be used. Use 'gs' for group server." + newLine
