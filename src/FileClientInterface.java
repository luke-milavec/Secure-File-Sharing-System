...
public interface FileClientInterface {
     ...
     *
     */
    public List<String> listFiles(final SignedToken token);
     ...
     *
     */
    public boolean upload(final String sourceFile, final String destFile, final String group, final SignedToken token);
     ...
     *
     */
    public boolean download(final String sourceFile, final String destFile, final SignedToken token);
     ...
     *
     */
    public boolean delete(final String filename, final SignedToken token);
